...
PRODUCT_COPY_FILES += \
    ...
    device/lge/bullhead/gps/gps.conf:$(TARGET_COPY_OUT_SYSTEM)/etc/gps.conf
...
# Keylayout
PRODUCT_COPY_FILES += \
    device/lge/bullhead/keylayout/gpio-keys.kl:$(TARGET_COPY_OUT_SYSTEM)/usr/keylayout/gpio-keys.kl \
    device/lge/bullhead/keylayout/qpnp_pon.kl:$(TARGET_COPY_OUT_SYSTEM)/usr/keylayout/qpnp_pon.kl \
    device/lge/bullhead/keylayout/uinput-fpc.kl:$(TARGET_COPY_OUT_SYSTEM)/usr/keylayout/uinput-fpc.kl
...
PRODUCT_COPY_FILES += \
    device/lge/bullhead/keylayout/synaptics_rmi4_i2c.idc:system/usr/idc/synaptics_rmi4_i2c.idc \
    device/lge/bullhead/keylayout/uinput-fpc.idc:$(TARGET_COPY_OUT_SYSTEM)/usr/idc/uinput-fpc.idc \
...
# MBN
PRODUCT_COPY_FILES += \
    device/lge/bullhead/rootdir/etc/init.bullhead.sh:$(TARGET_COPY_OUT_VENDOR)/bin/init.bullhead.sh
...
PRODUCT_COPY_FILES += \
    ...
    device/lge/bullhead/configs/media_codecs.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/media_codecs.xml \
    device/lge/bullhead/configs/media_codecs_performance.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/media_codecs_performance.xml \
    device/lge/bullhead/configs/media_profiles.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/media_profiles.xml
...
PRODUCT_COPY_FILES += \
    device/lge/bullhead/rootdir/etc/init.bullhead.power.sh:$(TARGET_COPY_OUT_VENDOR)/bin/init.bullhead.power.sh

# Qseecomd configuration file
PRODUCT_COPY_FILES += \
    device/lge/bullhead/rootdir/etc/init.bullhead.qseecomd.sh:$(TARGET_COPY_OUT_VENDOR)/bin/init.bullhead.qseecomd.sh
